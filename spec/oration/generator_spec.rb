...
module Oration
  describe Generator do
    ...
    it "generates an output directory ending with the cloud name" do
      ...
      File.absolute_path(a.output_directory).should == File.absolute_path("some/path-appengine")
      b = Generator.new file: "some/path/file.py", function: "blarg", cloud: "azure"
      File.absolute_path(b.output_directory).should == File.absolute_path("some/path-azure")
    end
    it "generates an output directory properly when the file is in working dir" do
      Dir.chdir "spec/data" do
        ...
        File.absolute_path(g.output_directory).should == File.absolute_path("../data-azure")
      end
    end
